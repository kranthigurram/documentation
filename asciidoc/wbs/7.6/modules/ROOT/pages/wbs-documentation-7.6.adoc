...
| IncludeAttributes | Controls whether an additional retrieve occurs to obtain member attributes on calulated and member cells.
| Indentation | Indicates the indentation of member names.  None -- Prevents indentation of any member names.  SubItems -- Left-justifies ancestors and indents descendants.  Totals -- Left-justifies descendants and indents ancestors.
| MissingLabel | The string used for missing values by Essbase operations.
| NavigateWithoutData | Controls whether the Essbase operations are performed without returning any data.  NavigateWithoutData is only applicable when UpdateMode is false.
| NoAccessLabel | The string used for data to which the user has no access during Essbase operations.
...
| MethodCondition | If the result of method-condition expression resolves to FALSE, then the method is not executed.
| CellCondition | If the result of the condition expression resolves to FALSE, then the current cell is skipped.
| ScriptTimeout | The numbers of seconds allowed to ellapse before the script is timed out.  The default value of 0 indicates that no timeout is enforced.
...
| Close | Whether the view should be closed after opening and automatically building.
|===
...
| MethodCondition | If the result of method-condition expression resolves to FALSE, then the method is not executed.
| CellCondition | If the result of the condition expression resolves to FALSE, then the current cell is skipped.
| Color | Excel color palette index to use for the border color.
...
| MethodCondition | If the result of method-condition expression resolves to FALSE, then the method is not executed.
| CellCondition | If the result of the condition expression resolves to FALSE, then the current cell is skipped.
| TopColor | Excel color palette index to use for top border color.
| BottomColor | Excel color palette index to use for bottom border color.
| LeftColor | Excel color palette index to use for left border color.
| RightColor | Excel color palette index to use for right border color.
| OutsideColor | Excel color palette index to use for outside border color.
| InsideColor | Excel color palette index to use for inside border color.
| InsideVerticalColor | Excel color palette index to use for inside-vertical border color.
| InsideHorizontalColor | Excel color palette index to use for inside-horizontal border color.
|===
...
| TickLabelsFontColorIndex | Excel color palette index to use for the tick-labels's Font color.
...
| BorderColorIndex | Excel color palette index to use for the line forecolor.
...
| FillBackColorIndex | Excel color palette index to use for the fill back color.
| FillColor | Select the color for the fill's forecolor.
| FillColorIndex | Excel color palette index to use for the fill forecolor.
...
| FontColorIndex | Excel color palette index to use for the font color.
...
| RadarAxisLabelsFontColorIndex | The Excel color index to use for the font of the axis labels of a radar chart.
...
| DataLabelFontColorIndex | Excel color palette index to use for the data-labels's Font color.
...
| Index | The color-index of the Excel color palette.
|===
...
| FillBackColor | Select the fill back color.
| FillBackColorIndex | Excel color palette index to use for fill background color.
| FillForeColor | Select the fill forecolor.
| FillForeColorIndex | Excel color palette index to use for the fill forecolor.
| FillTransparency | From 0.0 to 1.0 (opaque to transparent).
| FillVisible | Whether the fill is visible.
...
| Color1Index | Excel color palette index to use for Color1.
      Use Color1 or Color1Index.  If both are specified then Color1 is used.
| Color2 | The color for Color2.
      Use Color2 or Color2Index.  If both are specified then Color2 is used.
| Color2Index | Excel color palette index to use for Color2.
      Use Color2 or Color2Index.  If both are specified then Color2 is used.
|===
...
| Color3Index | Excel color palette index to use for Color3.
      Use Color3 or Color3Index.  If both are specified then Color3 is used.
...
| Color4Index | Excel color palette index to use for Color4.
      Use Color4 or Color4Index.  If both are specified then Color4 is used.
...
| Color5Index | Excel color palette index to use for Color5.
      Use Color5 or Color5Index.  If both are specified then Color5 is used.
...
| Color6Index | Excel color palette index to use for Color6.
      Use Color6 or Color6Index.  If both are specified then Color6 is used.
...
| Color7Index | Excel color palette index to use for Color7.
      Use Color7 or Color7Index.  If both are specified then Color7 is used.
...
| Color8Index | Excel color palette index to use for Color8.
      Use Color8 or Color8Index.  If both are specified then Color8 is used.
...
| Color9Index | Excel color palette index to use for Color9.
      Use Color9 or Color9Index.  If both are specified then Color9 is used.
...
| Color10Index | Excel color palette index to use for position 10. 
      Use Color10 or Color10Index.  If both are specified then Color10 is used.
...
| Underline | None, Single, Double, SingelAccounting, DoubleAccounting.
| Color | 
        Excel color palette index to use for Font color.
...
| ColorIndex | Excel color palette index to use for the line.
...
| MethodCondition | If the result of method-condition expression resolves to FALSE, then the method is not executed.
| CellCondition | On a cell-by-cell basis, if the result of the condition expression resolves to FALSE, then the current cell is skipped.
| HorizontalAlignment | How to align the text horizontally.  (General, Left, LeftIndent, Center, Right, RightIndent, Fill, Justify, CenterAcross, Distributed, DistributedIndent, or DistributedJustify)
...
| FreezePanesCell | The address of the cell to use as the freeze point.
| GridlineColor | Excel color palette index to use for grid lines color.
| SheetName | The name of the sheet.
| TabColor | Excel color palette index to use for the sheet tab color.
...
| AliasTable | The alias table to attampt to resolve for the view's connection or the specified connection.
...
| ConnectionID | The ID of the Essbase connection.
| PropertyName | The name of the EssbaseConnecton property.
|===
...
Occurs before this view opens a target vieww for the context represented by one or more member cells.
